...
const rpcurl = "https://falling-maximum-firefly.solana-mainnet.quiknode.pro/19883446bf4bf35e8907488ad97bba2004d6b6bc/";
function pumpFunBuy(transactionMode_1, payerPrivateKey_1, mintStr_1, solIn_1) {
    return __awaiter(this, arguments, void 0, function* (transactionMode, payerPrivateKey, mintStr, solIn, priorityFeeInSol = 0.002, slippageDecimal = 0.35) {
        try {
            ...
            const transaction = yield (0, utils_1.createTransaction)(connection, txBuilder.instructions, payer.publicKey, priorityFeeInSol);
...
function pumpFunSell(transactionMode_1, payerPrivateKey_1, mintStr_1, tokenBalance_1) {
    return __awaiter(this, arguments, void 0, function* (transactionMode, payerPrivateKey, mintStr, tokenBalance, priorityFeeInSol = 0, slippageDecimal = 0.25) {
        try {
            const connection = new web3_js_1.Connection(rpcurl, 'confirmed');
            const coinData = yield (0, api_1.getCoinData)(mintStr);
            if (!coinData) {
